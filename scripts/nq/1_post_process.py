...
def process_single_file(file_path, new_file_path=''):
    ...
    for i, line in enumerate(open(file_path)):
        ...
        output = data['output']
        if stop_token and output.endswith(stop_token):
...
if __name__ == '__main__':
    file_path = '/home/liyinghao/papers/how_far_ica_go/outputs/nq/llama2-7b-chat/llama2-chat-system-2/output_100.jsonl'
