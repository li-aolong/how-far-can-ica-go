...
model_names = ['llama2-13b']
model_paths = ['/home/liyinghao/models/modelscope/Llama-2-13b-ms/modelscope/Llama-2-13b-ms']
# icl_names = ['0_urial_urial', 'chatml_urial_gpt4web-2', 'chatml_urial_gpt4web-3']
...
cp /home/liyinghao/papers/how_far_ica_go/scripts/nq/0_run_batch_vllm_nq.py $output_path
...
for i, model_name in enumerate(model_names):
    ...
    if model_name == 'llama2-7b':
        icl_name = '0_urial_urial'
    elif model_name == 'llama2-13b':
        icl_name = 'chatml_urial_urial'
