...
cp /home/liyinghao/papers/how_far_ica_go/scripts/nq/0_run_batch_vllm_nq-chat.py $output_path
log_file=/home/liyinghao/papers/how_far_ica_go/outputs/nq/{model_name}/{icl_name}/nq.log

CUDA_VISIBLE_DEVICES=0 min_tokens=$min_tokens output_file_name=$output_file_name batch_size=$batch_size icl_path=$icl_path max_tokens=$max_tokens icl_name=$icl_name dataset=$dataset model_name=$model_name stop=$stop output_path=$output_path model_path=$model_path python /home/liyinghao/papers/how_far_ica_go/run_vllm.py 2>&1 | tee $log_file'''
