...
output_path=outputs/just-eval-instruct/{model_name}/table2_{icl_name}
echo ------------$output_path------------
mkdir -p $output_path
cp run_vllm.py $output_path
cp run_batch_vllm_table2.py $output_path
log_file=outputs/just-eval-instruct/{model_name}/table2_{icl_name}/safe_100_table2.log
